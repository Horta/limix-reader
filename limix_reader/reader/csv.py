...
def reader(filepath, row_header=False, col_header=False,
           genotype=False, dtype=float, na_values=None):
...
def _reader_table(filepath, row_header, col_header, na_values):
